...
img = cv2.resize(img,
                 (widthImg, heightImg))#RESIZE IMAGE TO MAKE IT A SQUARE IMAGE
...
if biggest.size != 0:
    ...
    print(biggest)
    cv2.drawContours(imgBigContour,
                     biggest,
                     -1,
                     (0, 0, 255),
                     25)#DRAW THE BIGGEST CONTOUR
    ...
    imgWarpColored = cv2.cvtColor(imgWarpColored,
                                  cv2.COLOR_BGR2GRAY)
