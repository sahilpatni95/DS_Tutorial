...
with st.sidebar.header('Upload your CSV data'):
    ...
    st.sidebar.markdown("""
    [Example CSV input file](https://raw.githubusercontent.com/sahilpatni95/streamlit-ML-projects/master/The%20AutoML%20App%20using%20lazypredict/delaney_solubility_with_descriptors.csv)
    """)
